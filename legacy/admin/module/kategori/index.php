    ...
    <table>
        <tr>
            <td style="width:25pc;"><input type="text" class="form-control" value="<?= $edit['nama_kategori'];?>"
                    required name="kategori" placeholder="Masukkan Kategori Barang Baru">
    ...
    <table>
        <tr>
            <td style="width:25pc;"><input type="text" class="form-control" required name="kategori"
                    placeholder="Masukkan Kategori Barang Baru"></td>
        ...
        <table class="table table-bordered table-striped table-sm" id="example1">
			...
			?>
                <tr>
                    ...
                    <?php if($role != 'kasir'): ?>
                    <td>
                        <a href="dashboard.php?page=kategori&uid=<?php echo $isi['id_kategori'];?>"><button

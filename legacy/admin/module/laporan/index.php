	...
	<div class="col-md-12">
		...
		<div class="card">
			...
			<div class="card-body p-0">
				<form method="post" action="dashboard.php?page=laporan&cari=ok">
					<table class="table table-striped">
						...
						<tr>
							...
							<td>
								...
								<a href="dashboard.php?page=laporan" class="btn btn-primary">
									<i class="fa fa-refresh"></i> Segarkan</a>
								...
								<a href="excel.php?cari=yes&bln=<?=$_POST['bln'];?>&thn=<?=$_POST['thn'];?>"
									...
									Excel</a>
								<?php }else{?>
								<a href="excel.php" class="btn btn-primary"><i class="fa fa-download"></i>
									Excel</a>
								<?php }?>
							</td>
						</tr>
				...
				<form method="post" action="dashboard.php?page=laporan&hari=cek">
					<table class="table table-striped">
						<tr>
							<th>
								Pilih Hari
						...
						<tr>
							...
							<td>
								...
								<a href="excel.php?hari=cek&tgl=<?= $_POST['hari'];?>" class="btn btn-primary"><i

<h4><b>Data Barang</b></h4>
        ...
        <?php 
			...
			if($r > 0){
				...
				<div class='alert alert-warning'>
					...
					<span class='pull-right'><a href='dashboard.php?page=barang&stok=yes'>Cek Barang <i class='fa fa-angle-double-right'></i></a></span>
				</div>
				";	
			}
		?>
        ...
        <?php endif; ?>
        <a href="dashboard.php?page=barang&stok=yes" class="btn btn-warning btn-md mr-2">
            <i class="fa fa-list"></i> Stok Menipis</a>
        <a href="dashboard.php?page=barang" class="btn btn-primary btn-md">
            <i class="fa fa-refresh"></i> Segarkan Data</a>
					...
					?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php }else{?>
                                <a href="dashboard.php?page=barang/details&barang=<?php echo $isi['id_barang'];?>"><button
                                        class="btn btn-primary btn-xs">Detail</button></a>
                                <?php if($role != 'kasir'): ?>
                                <a href="dashboard.php?page=barang/edit&barang=<?php echo $isi['id_barang'];?>"><button
                                        class="btn btn-warning btn-xs">Ubah</button></a>
                                <a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang'];?>"
                        ...
                        <div class="modal-body">
                            <table class="table table-striped bordered">
                                ...
                                <tr>
                                    <td>Kategori</td>
                                    <td>
                                        <input list="kategoriList" name="kategori" class="form-control" required
                                            placeholder="Ketik kategori atau pilih dari daftar">
                                        <datalist id="kategoriList">
                                            <?php  $kat = $lihat -> kategori(); foreach($kat as $isi){ 	?>
                                            <option value="<?php echo $isi['nama_kategori'];?>"></option>
                                            <?php }?>
                                        </datalist>
                                        <small class="text-muted">Bisa tulis kategori baru atau pilih kategori yang sudah ada.</small>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Nama Barang</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="satuan" class="form-control" required
                                            placeholder="Satuan Barang (misal: pcs, box, kg)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Stok</td>

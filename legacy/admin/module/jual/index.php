	...
	<div class="row">
		<div class="col-sm-4">
			<div class="card card-success mb-3">
				...
				<div class="card-body">
					<input type="text" id="cari" class="form-control" name="cari" placeholder="Masukkan : Kode / Nama Barang  [ENTER]">
				</div>
			</div>
		</div>
		<div class="col-sm-8">
				...
				<div class="card-body">
					...
					<div id="kasirnya">
						<table class="table table-stripped">
							...
							?>
							<!-- aksi ke table nota -->
							<form method="POST" action="dashboard.php?page=jual&nota=yes#kasirnya">
								<?php foreach($hasil_penjualan as $isi){;?>
								...
								<tr>
									...
									<td><input type="text" class="form-control" name="bayar" value="<?php echo $bayar;?>"></td>
												<td><button class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Bayar</button>
...
$(document).ready(function(){
    // Trigger search immediately to show all items
    $.ajax({
        type: "POST",

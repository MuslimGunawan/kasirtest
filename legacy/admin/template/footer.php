    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto text-dark">
                <span>
                    <?php echo date('Y');?> - Aplikasi Kasir <?php echo $toko['nama_toko'];?> |
                    BY <b><a href="" target="" class="text-dark"><?php echo $toko['nama_pemilik'];?></a></b>
                </span>
            </div>
        </div>
    </footer>
   ...
   <script type="application/javascript">
    ...
    $(document).ready(function() {
        setTimeout(function() {
            $(".alert-primary").fadeIn('slow');
        }, 500);
    });
    setTimeout(function() {
        $(".alert-primary").fadeOut('slow');
    }, 5000);
